...
import type { Program, KeywordStatement, SubKeyword, Literal, TextContent } from '../../parser/ast.js';
 ...
 */
export const validSubkeywordValue: LintRule = {
